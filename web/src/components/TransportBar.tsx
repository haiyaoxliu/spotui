...
export function TransportBar({
  ...
  const playButtons = (
    <div className="flex items-center gap-2">
      <button
        ...
        disabled={disabled}
        className="px-3 py-1.5 rounded bg-neutral-200 hover:bg-neutral-300 dark:bg-neutral-800 dark:hover:bg-neutral-700 disabled:opacity-40"
        title="Previous (k)"
      >
        ◀◀
      </button>
      <button
        ...
        disabled={disabled}
        // Intentional exception to the theme inversion: the play button
        // keeps its dark-mode look (light surface, dark glyph) in both
        // themes so it always reads as the prominent transport control.
        className="px-3 py-1.5 rounded bg-neutral-200 text-neutral-900 hover:bg-neutral-50 disabled:opacity-40 min-w-[48px]"
  ...
  const modes = (
    <div className="flex items-center gap-1">
      <button
        ...
        disabled={disabled}
        className={
          'px-2 py-1 rounded text-sm hover:bg-neutral-200 dark:hover:bg-neutral-800 disabled:opacity-40 ' +
      ...
      <button
        ...
        disabled={disabled}
        className={
          'px-2 py-1 rounded text-sm hover:bg-neutral-200 dark:hover:bg-neutral-800 disabled:opacity-40 tabular-nums ' +
  ...
  const volumeBarUI = (
    ...
    >
      <span>vol</span>
      <div className={`${barWidthClass} h-1 bg-neutral-200 dark:bg-neutral-800 rounded overflow-hidden`}>
  ...
  const volumeButtonsUI = (
    <div className="flex items-center gap-1 text-xs text-neutral-500 select-none" title={volumeTitle}>
      <button
        ...
        className="px-1.5 rounded bg-neutral-200 hover:bg-neutral-300 dark:bg-neutral-800 dark:hover:bg-neutral-700 disabled:opacity-40 leading-tight"
  ...
  if (compact) {
    ...
    return (
      <div className="border-b border-neutral-200 dark:border-neutral-800 px-3 py-2 grid grid-cols-[auto_1fr] items-center gap-x-3 gap-y-2">
        {playButtons}
  ...
  return (
    <div className="border-t border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 flex flex-col">
      ...
      <div className="px-4 py-2 flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="truncate text-xs text-neutral-600 dark:text-neutral-400">{subtitle}</div>
        </div>
        {volumeUI}
        <div className="text-xs text-neutral-600 dark:text-neutral-500 truncate max-w-[20%]">
